...
Random forest proved to have the highest accuracy.  With sufficient accuracy achieved, and with no changes or additional steps taken in fitting the model taken, additional levels of cross validation will not be necessary.  The testing set is sufficient.
